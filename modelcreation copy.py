...
data = pd.read_csv("data20240122_133302.csv")
...
coordinates = data[coordinates_columns]
...
normalized_coordinates['left_elbow.y']=normalized_coordinates['left_wrist.y']/(1/normalized_coordinates['left_wrist.z'])
normalized_coordinates['right_wrist.x']=normalized_coordinates['right_wrist.x']/(1/normalized_coordinates['right_wrist.z'])
normalized_coordinates['right_elbow.y']=normalized_coordinates['right_wrist.y']/(1/normalized_coordinates['right_wrist.z'])
...
joblib.dump(model, f'model_{accuracy*100}.pkl')